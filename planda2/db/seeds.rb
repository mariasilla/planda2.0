...
Task.create(name:"Laundry",frequency:"Weekly",completeness_level:"Still Need to Start",cycles:0,completed:0,user_id:1)
Task.create(name:"Clean bathroom",frequency:"Weekly", completeness_level:"Still Need to Start",cycles:0,completed:0,user_id:1)
Task.create(name:"Homework",frequency:"Daily",completeness_level:"Almost Done",cycles:0,completed:0,user_id:1)
Task.create(name:"Walk the dog",frequency:"Daily",completeness_level:"Finished!",cycles:0,completed:0,user_id:1)
...
Task.create(name:"Laundry",frequency:"Weekly",completeness_level:"Still Need to Start",cycles:0,completed:0,user_id:2)
Task.create(name:"Vacuum",frequency:"Weekly", completeness_level:"Still Need to Start",cycles:0,completed:0,user_id:2)
Task.create(name:"Change kitty litter",frequency:"Weekly",completeness_level:"Finished!",cycles:0,completed:0,user_id:2)
Task.create(name:"Swiffer",frequency:"Weekly",completeness_level:"Finished!",cycles:0,completed:0,user_id:2)
